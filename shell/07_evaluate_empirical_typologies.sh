...
OUTPUT_FILE="data/007_evaluations_empirical/${TAXON}_${MODEL_ID_PADDED}.rds"
...
singularity exec ../parent/shell/r_v1-4.sif Rscript ../parent/code/10_evaluate_empirical.R \
